# content-ops-057-activity-location-snowdonia-running

## Objective
Improve content item activity-location-snowdonia-running: Snowdonia / Running.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/running.
Region: snowdonia.
Activity: running.
...
- Content item: activity-location-snowdonia-running
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/running
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-running.json
