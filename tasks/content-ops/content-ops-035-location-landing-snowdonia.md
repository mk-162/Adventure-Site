# content-ops-035-location-landing-snowdonia

## Objective
Improve content item location-landing-snowdonia: Snowdonia.
Channel: evergreen. Content type: location_landing. Route/slug: /snowdonia.
Region: snowdonia.
...
- Content item: location-landing-snowdonia
- Channel: evergreen
- Content type: location_landing
- Route/slug: /snowdonia
- Current status: qa_needed
- Priority: 45
- Task type: qa
- Recommended skill: directory-region-page
- Required output path: data/research/content-ops/location-landing-snowdonia.json
