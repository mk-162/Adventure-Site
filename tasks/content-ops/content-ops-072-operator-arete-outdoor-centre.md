# content-ops-072-operator-arete-outdoor-centre

## Objective
Improve content item operator-arete-outdoor-centre: Arete Outdoor Centre.
Channel: commercial. Content type: operator. Route/slug: /directory/arete-outdoor-centre.
Commercial tier: unclassified_operator.
Known blocker: Operator "Arete Outdoor Centre" missing: no description, no cover image, no logo, no coordinates, no phone, no email, no Google rating | Operator "Arete Outdoor Centre" missing: no description, no cover image, no logo, no coordinates, no phone, no email, no Google rating.
...
- Content item: operator-arete-outdoor-centre
- Channel: commercial
- Content type: operator
- Route/slug: /directory/arete-outdoor-centre
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-arete-outdoor-centre.json
