          ...
          {showSpotForm && createSpotAction && (
            ...
            >
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      name="spotName"
                      required
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f97316] focus:border-transparent text-sm"
              ...
              <div className="flex justify-end gap-3 mt-4">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-[#f97316] text-white rounded-lg hover:bg-[#ea580c] transition-colors text-sm"
                >
                  Add Spot
                </button>
              </div>
