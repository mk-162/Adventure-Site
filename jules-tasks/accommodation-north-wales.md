# Accommodation Research: North-wales

## Objective
Deep dive into the best hotels and accommodation options in North-wales for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/north-wales.json`
