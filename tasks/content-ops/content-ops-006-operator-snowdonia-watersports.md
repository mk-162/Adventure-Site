# content-ops-006-operator-snowdonia-watersports

## Objective
Improve content item operator-snowdonia-watersports: Snowdonia Watersports.
Channel: commercial. Content type: operator. Route/slug: /directory/snowdonia-watersports.
Commercial tier: strategic_big_player_or_launch_priority.
Known blocker: Operator "Snowdonia Watersports" missing: no description, no cover image, no logo, no email, no Google rating | Operator "Snowdonia Watersports" missing: no description, no cover image, no logo, no email, no Google rating.
...
- Content item: operator-snowdonia-watersports
- Channel: commercial
- Content type: operator
- Route/slug: /directory/snowdonia-watersports
- Current status: qa_needed
- Priority: 59
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-snowdonia-watersports.json
