# content-ops-051-activity-location-snowdonia-kitesurfing

## Objective
Improve content item activity-location-snowdonia-kitesurfing: Snowdonia / Kitesurfing.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/kitesurfing.
Region: snowdonia.
...
- Content item: activity-location-snowdonia-kitesurfing
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/kitesurfing
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-kitesurfing.json
