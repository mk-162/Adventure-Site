# Accommodation Research: Gower

## Objective
Deep dive into the best hotels and accommodation options in Gower for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/gower.json`
