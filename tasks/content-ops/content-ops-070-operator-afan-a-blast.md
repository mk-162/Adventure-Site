# content-ops-070-operator-afan-a-blast

## Objective
Improve content item operator-afan-a-blast: Afan A Blast.
Channel: commercial. Content type: operator. Route/slug: /directory/afan-a-blast.
Commercial tier: unclassified_operator.
Known blocker: Operator "Afan A Blast" missing: no description, no cover image, no logo, no website, no phone, no email, no Google rating | Operator "Afan A Blast" missing: no description, no cover image, no logo, no website, no phone, no email, no Google rating.
...
- Content item: operator-afan-a-blast
- Channel: commercial
- Content type: operator
- Route/slug: /directory/afan-a-blast
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-afan-a-blast.json
