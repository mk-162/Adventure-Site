# content-ops-045-activity-location-snowdonia-fishing

## Objective
Improve content item activity-location-snowdonia-fishing: Snowdonia / Fishing.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/fishing.
Region: snowdonia.
Activity: fishing.
...
- Content item: activity-location-snowdonia-fishing
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/fishing
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-fishing.json
