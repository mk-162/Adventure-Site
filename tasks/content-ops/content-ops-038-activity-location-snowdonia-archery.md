# content-ops-038-activity-location-snowdonia-archery

## Objective
Improve content item activity-location-snowdonia-archery: Snowdonia / Archery.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/archery.
Region: snowdonia.
Activity: archery.
...
- Content item: activity-location-snowdonia-archery
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/archery
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-archery.json
