# content-ops-085-operator-celtic-trail-shuttle

## Objective
Improve content item operator-celtic-trail-shuttle: Celtic Trail Shuttle.
Channel: commercial. Content type: operator. Route/slug: /directory/celtic-trail-shuttle.
Commercial tier: unclassified_operator.
Known blocker: Operator "Celtic Trail Cycle Shuttle" missing: no cover image, no logo, no coordinates, no Google rating | Operator "Celtic Trail Cycle Shuttle" missing: no cover image, no logo, no coordinates, no Google rating.
...
- Content item: operator-celtic-trail-shuttle
- Channel: commercial
- Content type: operator
- Route/slug: /directory/celtic-trail-shuttle
- Current status: blocked
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-celtic-trail-shuttle.json
