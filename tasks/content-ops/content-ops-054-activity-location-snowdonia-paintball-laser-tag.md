# content-ops-054-activity-location-snowdonia-paintball-laser-tag

## Objective
Improve content item activity-location-snowdonia-paintball-laser-tag: Snowdonia / Paintball Laser Tag.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/paintball-laser-tag.
Region: snowdonia.
Activity: paintball-laser-tag.
...
- Content item: activity-location-snowdonia-paintball-laser-tag
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/paintball-laser-tag
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-paintball-laser-tag.json
