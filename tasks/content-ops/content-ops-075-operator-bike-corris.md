# content-ops-075-operator-bike-corris

## Objective
Improve content item operator-bike-corris: Bike Corris.
Channel: commercial. Content type: operator. Route/slug: /directory/bike-corris.
Commercial tier: unclassified_operator.
Known blocker: Operator "Bike Corris" missing: no cover image, no logo, no phone, no email, no Google rating | Operator "Bike Corris" missing: no cover image, no logo, no phone, no email, no Google rating.
...
- Content item: operator-bike-corris
- Channel: commercial
- Content type: operator
- Route/slug: /directory/bike-corris
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-bike-corris.json
