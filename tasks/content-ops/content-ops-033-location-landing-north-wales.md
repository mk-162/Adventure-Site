# content-ops-033-location-landing-north-wales

## Objective
Improve content item location-landing-north-wales: North Wales.
Channel: evergreen. Content type: location_landing. Route/slug: /north-wales.
Region: north-wales.
...
- Content item: location-landing-north-wales
- Channel: evergreen
- Content type: location_landing
- Route/slug: /north-wales
- Current status: research_needed
- Priority: 45
- Task type: research
- Recommended skill: directory-region-page
- Required output path: data/research/content-ops/location-landing-north-wales.json
