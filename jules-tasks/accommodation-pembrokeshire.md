# Accommodation Research: Pembrokeshire

## Objective
Deep dive into the best hotels and accommodation options in Pembrokeshire for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/pembrokeshire.json`
