    ...
    <div className="min-h-screen pt-4 lg:pt-8 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span className="text-[#1e3a4c] font-medium">Terms of Service</span>
        </div>
        ...
        <div className="bg-[#1e3a4c]/5 rounded-2xl p-6 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-2 text-sm">
            <a href="#acceptance" className="text-[#1e3a4c] hover:underline">1. Acceptance of Terms</a>
            <a href="#platform" className="text-[#1e3a4c] hover:underline">2. Our Platform</a>
            <a href="#accounts" className="text-[#1e3a4c] hover:underline">3. User Accounts</a>
            <a href="#bookings" className="text-[#1e3a4c] hover:underline">4. Bookings and Payments</a>
            <a href="#risk" className="text-[#1e3a4c] hover:underline">5. Assumption of Risk</a>
            <a href="#cancellations" className="text-[#1e3a4c] hover:underline">6. Cancellations and Refunds</a>
            <a href="#conduct" className="text-[#1e3a4c] hover:underline">7. User Conduct</a>
            <a href="#content" className="text-[#1e3a4c] hover:underline">8. User Content</a>
            <a href="#intellectual" className="text-[#1e3a4c] hover:underline">9. Intellectual Property</a>
            <a href="#liability" className="text-[#1e3a4c] hover:underline">10. Limitation of Liability</a>
            <a href="#disputes" className="text-[#1e3a4c] hover:underline">11. Disputes and Governing Law</a>
            <a href="#general" className="text-[#1e3a4c] hover:underline">12. General Provisions</a>
          </div>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section id="platform" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">2. Our Platform</h2>
            
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">2.1 Platform Role</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">2.2 Operator Relationships</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">2.3 Information Accuracy</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="accounts" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">3. User Accounts</h2>
            
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">3.1 Account Creation</h3>
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">3.2 Account Responsibilities</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">3.3 Account Termination</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="bookings" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">4. Bookings and Payments</h2>
            
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">4.1 Booking Process</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">4.2 Pricing and Fees</h3>
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">4.3 Payment Processing</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">4.4 Booking Modifications</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="risk" className="mb-10">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">5.1 Your Acknowledgment</h3>
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">5.2 Operator Waivers</h3>
            <p className="text-gray-600 mb-4">
              Operators may require you to sign additional waivers. These are separate agreements 
              between you and the operator.
            </p>

            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">5.3 Insurance</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="cancellations" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">6. Cancellations and Refunds</h2>
            
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">6.1 Cancellation Policies</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">6.2 Weather Cancellations</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">6.3 Platform Service Fees</h3>
            <p className="text-gray-600 mb-4">
              Our service fees may be non-refundable, even if the activity is canceled. This will be 
              clearly stated during booking.
            </p>

            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">6.4 Refund Processing</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="conduct" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">7. User Conduct</h2>
          ...
          <section id="content" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">8. User Content</h2>
            
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">8.1 Reviews and Feedback</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">8.2 Content Standards</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">8.3 Content Responsibility</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="intellectual" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">9. Intellectual Property</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section id="liability" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">10. Limitation of Liability</h2>
            
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">10.1 Platform Provided "As Is"</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">10.2 Activity Liability</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">10.3 Limitation of Damages</h3>
            <p className="text-gray-600 mb-4">
              To the maximum extent permitted by law, our total liability for any claim shall not exceed 
              the amount you paid us in the 12 months preceding the claim.
            </p>

            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">10.4 Exclusions</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="disputes" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">11. Disputes and Governing Law</h2>
            
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">11.1 Governing Law</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#1e3a4c] mt-6 mb-3">11.3 Consumer Rights</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section id="general" className="mb-10">
            <h2 className="text-2xl font-bold text-[#1e3a4c] mb-4">12. General Provisions</h2>
        ...
        {/* Contact Section */}
        <div className="mt-12 bg-[#1e3a4c] rounded-2xl p-8 text-white text-center">
