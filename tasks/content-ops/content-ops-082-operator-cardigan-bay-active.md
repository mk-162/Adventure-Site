# content-ops-082-operator-cardigan-bay-active

## Objective
Improve content item operator-cardigan-bay-active: Cardigan Bay Active.
Channel: commercial. Content type: operator. Route/slug: /directory/cardigan-bay-active.
Commercial tier: unclassified_operator.
Known blocker: Operator "Cardigan Bay Active" missing: no description, no cover image, no logo, no coordinates, no phone, no email, no Google rating | Operator "Cardigan Bay Active" missing: no description, no cover image, no logo, no coordinates, no phone, no email, no Google rating.
...
- Content item: operator-cardigan-bay-active
- Channel: commercial
- Content type: operator
- Route/slug: /directory/cardigan-bay-active
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-cardigan-bay-active.json
