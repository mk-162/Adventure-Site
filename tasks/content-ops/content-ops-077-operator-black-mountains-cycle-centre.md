# content-ops-077-operator-black-mountains-cycle-centre

## Objective
Improve content item operator-black-mountains-cycle-centre: Black Mountains Cycle Centre.
Channel: commercial. Content type: operator. Route/slug: /directory/black-mountains-cycle-centre.
Commercial tier: unclassified_operator.
Known blocker: Operator "Black Mountains Cycle Centre" missing: no cover image, no logo, no phone, no email, no Google rating | Operator "Black Mountains Cycle Centre" missing: no cover image, no logo, no phone, no email, no Google rating.
...
- Content item: operator-black-mountains-cycle-centre
- Channel: commercial
- Content type: operator
- Route/slug: /directory/black-mountains-cycle-centre
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-black-mountains-cycle-centre.json
