# Accommodation Research: Anglesey

## Objective
Deep dive into the best hotels and accommodation options in Anglesey for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/anglesey.json`
