# content-ops-019-activity-location-snowdonia-zip-lining

## Objective
Improve content item activity-location-snowdonia-zip-lining: Snowdonia / Zip Lining.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/zip-lining.
Region: snowdonia.
Activity: zip-lining.
...
- Content item: activity-location-snowdonia-zip-lining
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/zip-lining
- Current status: qa_needed
- Priority: 50
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-zip-lining.json
