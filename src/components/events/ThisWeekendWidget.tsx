  ...
  if (events.length === 0) {
    return (
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
        ...
        <Link
          href="/calendar"
          className="text-accent-strong text-sm font-bold hover:underline flex items-center gap-1"
        >
      ...
      <div className="p-6 border-b border-slate-50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-bold text-accent-strong uppercase tracking-wider">{subtitle}</span>
          ...
          >
            <div className="flex gap-4">
              ...
              <div className="min-w-0">
                <h4 className="font-bold text-primary text-sm truncate group-hover:text-accent-strong transition-colors">
                  {event.name}
                </h4>
