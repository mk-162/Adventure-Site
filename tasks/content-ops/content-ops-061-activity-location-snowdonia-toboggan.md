# content-ops-061-activity-location-snowdonia-toboggan

## Objective
Improve content item activity-location-snowdonia-toboggan: Snowdonia / Toboggan.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/toboggan.
Region: snowdonia.
Activity: toboggan.
...
- Content item: activity-location-snowdonia-toboggan
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/toboggan
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-toboggan.json
