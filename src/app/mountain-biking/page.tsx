...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://adventurewales.co.uk/mountain-biking",
  },
  openGraph: {
    title: mountainBikingHub.metaTitle,
    description: mountainBikingHub.metaDescription,
            ...
            <div className="mb-10">
              <QuickAnswerBox
                bestForBeginners={{
                  ...
                  // Launch gate: north-wales isn't launched yet; fall back to the
                  // trail-centre table on this page (Coed Llandegla is listed there).
                  link: isLaunchCombo("north-wales", "mountain-biking")
                    ? "/north-wales/mountain-biking"
                    : isLaunchRegion("north-wales")
                      ? "/north-wales"
                      : "#trail-centres",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mountainBikingHub.regions.map((region) => {
              ...
              const href = isLaunchCombo(region.slug, "mountain-biking")
                ? `/${region.slug}/mountain-biking`
