# content-ops-055-activity-location-snowdonia-powerboating

## Objective
Improve content item activity-location-snowdonia-powerboating: Snowdonia / Powerboating.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/powerboating.
Region: snowdonia.
Activity: powerboating.
...
- Content item: activity-location-snowdonia-powerboating
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/powerboating
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-powerboating.json
