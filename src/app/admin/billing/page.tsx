...
export default async function AdminBillingPage() {
  ...
  const verifiedRevenue = verified.length * 9.99;
  const totalMRR = premiumRevenue + verifiedRevenue;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-lg shadow-sm border">
          <p className="text-sm text-slate-500 uppercase tracking-wider">Verified</p>
          <p className="text-3xl font-bold text-blue-600 mt-1">{verified.length}</p>
          <p className="text-xs text-slate-400">£{verifiedRevenue.toFixed(2)}/mo</p>
        </div>
        <div className="bg-white p-5 rounded-lg shadow-sm border">
