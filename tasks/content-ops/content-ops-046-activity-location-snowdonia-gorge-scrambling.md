# content-ops-046-activity-location-snowdonia-gorge-scrambling

## Objective
Improve content item activity-location-snowdonia-gorge-scrambling: Snowdonia / Gorge Scrambling.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/gorge-scrambling.
Region: snowdonia.
...
- Content item: activity-location-snowdonia-gorge-scrambling
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/gorge-scrambling
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-gorge-scrambling.json
