# content-ops-024-operator-snowdonia-mountain-guides

## Objective
Improve content item operator-snowdonia-mountain-guides: Snowdonia Mountain Guides.
Channel: commercial. Content type: operator. Route/slug: /directory/snowdonia-mountain-guides.
Commercial tier: strategic_big_player_or_launch_priority.
Known blocker: Operator "Snowdonia Mountain Guides" missing: no cover image.
...
- Content item: operator-snowdonia-mountain-guides
- Channel: commercial
- Content type: operator
- Route/slug: /directory/snowdonia-mountain-guides
- Current status: qa_needed
- Priority: 47
- Task type: research
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-snowdonia-mountain-guides.json
