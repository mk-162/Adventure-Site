# content-ops-042-activity-location-snowdonia-canyoning

## Objective
Improve content item activity-location-snowdonia-canyoning: Snowdonia / Canyoning.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/canyoning.
Region: snowdonia.
Activity: canyoning.
...
- Content item: activity-location-snowdonia-canyoning
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/canyoning
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-canyoning.json
