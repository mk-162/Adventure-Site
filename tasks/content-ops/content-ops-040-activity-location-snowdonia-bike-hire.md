# content-ops-040-activity-location-snowdonia-bike-hire

## Objective
Improve content item activity-location-snowdonia-bike-hire: Snowdonia / Bike Hire.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/bike-hire.
Region: snowdonia.
Activity: bike-hire.
...
- Content item: activity-location-snowdonia-bike-hire
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/bike-hire
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-bike-hire.json
