# content-ops-034-location-landing-pembrokeshire

## Objective
Improve content item location-landing-pembrokeshire: Pembrokeshire.
Channel: evergreen. Content type: location_landing. Route/slug: /pembrokeshire.
...
- Content item: location-landing-pembrokeshire
- Channel: evergreen
- Content type: location_landing
- Route/slug: /pembrokeshire
- Current status: qa_needed
- Priority: 45
- Task type: qa
- Recommended skill: directory-region-page
- Required output path: data/research/content-ops/location-landing-pembrokeshire.json
