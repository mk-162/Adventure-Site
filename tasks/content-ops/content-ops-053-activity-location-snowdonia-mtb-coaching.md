# content-ops-053-activity-location-snowdonia-mtb-coaching

## Objective
Improve content item activity-location-snowdonia-mtb-coaching: Snowdonia / Mtb Coaching.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/mtb-coaching.
Region: snowdonia.
Activity: mtb-coaching.
...
- Content item: activity-location-snowdonia-mtb-coaching
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/mtb-coaching
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-mtb-coaching.json
