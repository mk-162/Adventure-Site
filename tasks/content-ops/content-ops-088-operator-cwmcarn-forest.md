# content-ops-088-operator-cwmcarn-forest

## Objective
Improve content item operator-cwmcarn-forest: Cwmcarn Forest.
Channel: commercial. Content type: operator. Route/slug: /directory/cwmcarn-forest.
Commercial tier: unclassified_operator.
Known blocker: Operator "Cwmcarn Forest" missing: no cover image, no logo, no phone, no email | Operator "Cwmcarn Forest" missing: no cover image, no logo, no phone, no email.
...
- Content item: operator-cwmcarn-forest
- Channel: commercial
- Content type: operator
- Route/slug: /directory/cwmcarn-forest
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-cwmcarn-forest.json
