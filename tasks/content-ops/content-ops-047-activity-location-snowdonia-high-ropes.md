# content-ops-047-activity-location-snowdonia-high-ropes

## Objective
Improve content item activity-location-snowdonia-high-ropes: Snowdonia / High Ropes.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/high-ropes.
Region: snowdonia.
Activity: high-ropes.
...
- Content item: activity-location-snowdonia-high-ropes
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/high-ropes
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-high-ropes.json
