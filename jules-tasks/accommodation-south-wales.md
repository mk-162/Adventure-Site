# Accommodation Research: South-wales

## Objective
Deep dive into the best hotels and accommodation options in South-wales for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/south-wales.json`
