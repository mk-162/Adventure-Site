# content-ops-090-operator-dyfi-bike-park

## Objective
Improve content item operator-dyfi-bike-park: Dyfi Bike Park.
Channel: commercial. Content type: operator. Route/slug: /directory/dyfi-bike-park.
Commercial tier: unclassified_operator.
Known blocker: Operator "Dyfi Bike Park" missing: no description, no cover image, no logo, no phone, no email, no Google rating | Operator "Dyfi Bike Park" missing: no description, no cover image, no logo, no phone, no email, no Google rating.
...
- Content item: operator-dyfi-bike-park
- Channel: commercial
- Content type: operator
- Route/slug: /directory/dyfi-bike-park
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-dyfi-bike-park.json
