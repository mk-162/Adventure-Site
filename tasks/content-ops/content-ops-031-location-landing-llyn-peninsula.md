# content-ops-031-location-landing-llyn-peninsula

## Objective
Improve content item location-landing-llyn-peninsula: Llyn Peninsula.
Channel: evergreen. Content type: location_landing. Route/slug: /llyn-peninsula.
...
- Content item: location-landing-llyn-peninsula
- Channel: evergreen
- Content type: location_landing
- Route/slug: /llyn-peninsula
- Current status: qa_needed
- Priority: 45
- Task type: qa
- Recommended skill: directory-region-page
- Required output path: data/research/content-ops/location-landing-llyn-peninsula.json
