# Accommodation Research: Mid-wales

## Objective
Deep dive into the best hotels and accommodation options in Mid-wales for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/mid-wales.json`
