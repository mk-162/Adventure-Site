# content-ops-008-activity-location-snowdonia-caving

## Objective
Improve content item activity-location-snowdonia-caving: Snowdonia / Caving.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/caving.
Region: snowdonia.
Activity: caving.
...
- Content item: activity-location-snowdonia-caving
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/caving
- Current status: qa_needed
- Priority: 50
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-caving.json
