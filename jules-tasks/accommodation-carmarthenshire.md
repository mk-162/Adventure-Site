# Accommodation Research: Carmarthenshire

## Objective
Deep dive into the best hotels and accommodation options in Carmarthenshire for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/carmarthenshire.json`
