# content-ops-029-location-landing-carmarthenshire

## Objective
Improve content item location-landing-carmarthenshire: Carmarthenshire.
Channel: evergreen. Content type: location_landing. Route/slug: /carmarthenshire.
...
- Content item: location-landing-carmarthenshire
- Channel: evergreen
- Content type: location_landing
- Route/slug: /carmarthenshire
- Current status: qa_needed
- Priority: 45
- Task type: qa
- Recommended skill: directory-region-page
- Required output path: data/research/content-ops/location-landing-carmarthenshire.json
