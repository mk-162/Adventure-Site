# Accommodation Research: Llyn-peninsula

## Objective
Deep dive into the best hotels and accommodation options in Llyn-peninsula for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/llyn-peninsula.json`
