# content-ops-071-operator-afan-forest-park

## Objective
Improve content item operator-afan-forest-park: Afan Forest Park.
Channel: commercial. Content type: operator. Route/slug: /directory/afan-forest-park.
Commercial tier: unclassified_operator.
Known blocker: Operator "Afan Forest Park" missing: no cover image, no logo, no phone, no email | Operator "Afan Forest Park" missing: no cover image, no logo, no phone, no email.
...
- Content item: operator-afan-forest-park
- Channel: commercial
- Content type: operator
- Route/slug: /directory/afan-forest-park
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-afan-forest-park.json
