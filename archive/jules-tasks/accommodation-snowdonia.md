# Accommodation Research: Snowdonia

## Objective
Deep dive into the best hotels and accommodation options in Snowdonia (Eryri) for Adventure Wales directory.
...
- Proximity to key adventure spots (Pen y Pass, Zip World, etc.)
...
- Climbing huts, mountain huts
- Accommodation with on-site activities
- Places popular with specific communities (climbers, hikers, MTB)

## Output Format
Create JSON file: `data/accommodation/snowdonia.json`
