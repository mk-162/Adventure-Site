# content-ops-020-operator-antur-stiniog

## Objective
Improve content item operator-antur-stiniog: Antur Stiniog.
Channel: commercial. Content type: operator. Route/slug: /directory/antur-stiniog.
Commercial tier: strategic_big_player_or_launch_priority.
Known blocker: Operator "Antur Stiniog" missing: no cover image.
...
- Content item: operator-antur-stiniog
- Channel: commercial
- Content type: operator
- Route/slug: /directory/antur-stiniog
- Current status: qa_needed
- Priority: 47
- Task type: research
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-antur-stiniog.json
