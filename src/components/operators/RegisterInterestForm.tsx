    ...
    return (
      <div className="text-center py-12 px-6">
        ...
        <p className="text-slate-600 max-w-md mx-auto">
          ...
          <a href="/directory" className="text-accent-strong hover:underline font-medium">
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-accent-strong focus:ring-2 focus:ring-accent-strong/20 outline-none transition-all text-slate-900"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-accent-strong focus:ring-2 focus:ring-accent-strong/20 outline-none transition-all text-slate-900 bg-white"
          >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-accent-strong focus:ring-2 focus:ring-accent-strong/20 outline-none transition-all text-slate-900 resize-none"
      ...
      <button
        ...
        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-accent-strong text-white font-semibold rounded-full hover:bg-accent-strong focus:ring-2 focus:ring-accent-strong focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {status === "submitting" ? (
          <>
