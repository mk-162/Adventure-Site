# content-ops-087-operator-climb-snowdon

## Objective
Improve content item operator-climb-snowdon: Climb Snowdon.
Channel: commercial. Content type: operator. Route/slug: /directory/climb-snowdon.
Commercial tier: unclassified_operator.
Known blocker: Operator "Climb Snowdon" missing: no cover image, no logo, no phone, no Google rating | Operator "Climb Snowdon" missing: no cover image, no logo, no phone, no Google rating.
...
- Content item: operator-climb-snowdon
- Channel: commercial
- Content type: operator
- Route/slug: /directory/climb-snowdon
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-climb-snowdon.json
