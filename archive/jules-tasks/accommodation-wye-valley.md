# Accommodation Research: Wye-valley

## Objective
Deep dive into the best hotels and accommodation options in Wye-valley for Adventure Wales directory.
...
## Output Format
Create JSON file: `data/accommodation/wye-valley.json`
