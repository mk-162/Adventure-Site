    ...
    <div className="min-h-screen pt-4 lg:pt-8 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span className="text-[#1e3a4c] font-medium">Careers</span>
        </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-3 text-sm">
                      ...
                      <span className="px-3 py-1 bg-[#1e3a4c]/10 text-[#1e3a4c] rounded-full text-xs font-medium">
                        {role.type}
                      </span>
                    </div>
                  </div>
        ...
        {/* No Perfect Match */}
        <section className="bg-[#1e3a4c]/5 rounded-2xl p-8 lg:p-12 mb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#1e3a4c] text-white font-semibold rounded-xl hover:bg-[#2a5570] transition-colors"
            >
