# content-ops-080-operator-campbell-coaching

## Objective
Improve content item operator-campbell-coaching: Campbell Coaching.
Channel: commercial. Content type: operator. Route/slug: /directory/campbell-coaching.
Commercial tier: unclassified_operator.
Known blocker: Operator "Campbell Coaching" missing: no cover image, no logo, no phone, no email, no Google rating | Operator "Campbell Coaching" missing: no cover image, no logo, no phone, no email, no Google rating.
...
- Content item: operator-campbell-coaching
- Channel: commercial
- Content type: operator
- Route/slug: /directory/campbell-coaching
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-campbell-coaching.json
