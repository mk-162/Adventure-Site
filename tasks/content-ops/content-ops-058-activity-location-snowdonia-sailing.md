# content-ops-058-activity-location-snowdonia-sailing

## Objective
Improve content item activity-location-snowdonia-sailing: Snowdonia / Sailing.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/sailing.
Region: snowdonia.
Activity: sailing.
...
- Content item: activity-location-snowdonia-sailing
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/sailing
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-sailing.json
