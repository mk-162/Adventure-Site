        ...
        {cards.map((card) => (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <ArrowRight className="h-5 w-5 text-gray-400 group-hover:text-accent-hover transition-colors" />
            </div>
            <div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <Link
            ...
            className="flex items-center justify-center gap-2 p-4 rounded-lg border border-gray-200 hover:border-accent-hover hover:text-accent-hover transition-colors"
          >
