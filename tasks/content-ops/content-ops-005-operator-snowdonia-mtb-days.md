# content-ops-005-operator-snowdonia-mtb-days

## Objective
Improve content item operator-snowdonia-mtb-days: Snowdonia Mtb Days.
Channel: commercial. Content type: operator. Route/slug: /directory/snowdonia-mtb-days.
Commercial tier: strategic_big_player_or_launch_priority.
Known blocker: Operator "Snowdonia MTB Days" missing: no description, no cover image, no logo, no website, no phone, no email, no Google rating | Operator "Snowdonia MTB Days" missing: no description, no cover image, no logo, no website, no phone, no email, no Google rating.
...
- Content item: operator-snowdonia-mtb-days
- Channel: commercial
- Content type: operator
- Route/slug: /directory/snowdonia-mtb-days
- Current status: blocked
- Priority: 59
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-snowdonia-mtb-days.json
