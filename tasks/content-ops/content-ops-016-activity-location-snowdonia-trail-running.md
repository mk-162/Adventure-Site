# content-ops-016-activity-location-snowdonia-trail-running

## Objective
Improve content item activity-location-snowdonia-trail-running: Snowdonia / Trail Running.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/trail-running.
Region: snowdonia.
...
- Content item: activity-location-snowdonia-trail-running
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/trail-running
- Current status: qa_needed
- Priority: 50
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-trail-running.json
