# content-ops-044-activity-location-snowdonia-coasteering

## Objective
Improve content item activity-location-snowdonia-coasteering: Snowdonia / Coasteering.
Channel: evergreen. Content type: activity_location. Route/slug: /snowdonia/things-to-do/coasteering.
Region: snowdonia.
...
- Content item: activity-location-snowdonia-coasteering
- Channel: evergreen
- Content type: activity_location
- Route/slug: /snowdonia/things-to-do/coasteering
- Current status: qa_needed
- Priority: 41
- Task type: qa
- Recommended skill: directory-activity-region-page
- Required output path: data/research/content-ops/activity-location-snowdonia-coasteering.json
