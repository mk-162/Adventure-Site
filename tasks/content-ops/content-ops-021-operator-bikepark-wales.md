# content-ops-021-operator-bikepark-wales

## Objective
Improve content item operator-bikepark-wales: Bikepark Wales.
Channel: commercial. Content type: operator. Route/slug: /directory/bikepark-wales.
Commercial tier: strategic_big_player_or_launch_priority.
Known blocker: Operator "BikePark Wales" missing: no cover image.
...
- Content item: operator-bikepark-wales
- Channel: commercial
- Content type: operator
- Route/slug: /directory/bikepark-wales
- Current status: qa_needed
- Priority: 47
- Task type: research
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-bikepark-wales.json
