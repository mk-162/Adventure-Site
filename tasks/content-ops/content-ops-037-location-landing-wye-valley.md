# content-ops-037-location-landing-wye-valley

## Objective
Improve content item location-landing-wye-valley: Wye Valley.
Channel: evergreen. Content type: location_landing. Route/slug: /wye-valley.
Region: wye-valley.
...
- Content item: location-landing-wye-valley
- Channel: evergreen
- Content type: location_landing
- Route/slug: /wye-valley
- Current status: qa_needed
- Priority: 45
- Task type: qa
- Recommended skill: directory-region-page
- Required output path: data/research/content-ops/location-landing-wye-valley.json
