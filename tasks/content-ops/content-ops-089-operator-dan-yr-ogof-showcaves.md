# content-ops-089-operator-dan-yr-ogof-showcaves

## Objective
Improve content item operator-dan-yr-ogof-showcaves: Dan Yr Ogof Showcaves.
Channel: commercial. Content type: operator. Route/slug: /directory/dan-yr-ogof-showcaves.
Commercial tier: unclassified_operator.
Known blocker: Operator "Dan yr Ogof Showcaves" missing: no cover image, no logo, no coordinates, no phone, no email | Operator "Dan yr Ogof Showcaves" missing: no cover image, no logo, no coordinates, no phone, no email.
...
- Content item: operator-dan-yr-ogof-showcaves
- Channel: commercial
- Content type: operator
- Route/slug: /directory/dan-yr-ogof-showcaves
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-dan-yr-ogof-showcaves.json
