# content-ops-100-operator-gower-adventures

## Objective
Improve content item operator-gower-adventures: Gower Adventures.
Channel: commercial. Content type: operator. Route/slug: /directory/gower-adventures.
Commercial tier: unclassified_operator.
Known blocker: Operator "Gower Adventures" missing: no description, no cover image, no logo, no Google rating | Operator "Gower Adventures" missing: no description, no cover image, no logo, no Google rating.
...
- Content item: operator-gower-adventures
- Channel: commercial
- Content type: operator
- Route/slug: /directory/gower-adventures
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-gower-adventures.json
