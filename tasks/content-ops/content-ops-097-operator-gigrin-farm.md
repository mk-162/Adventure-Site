# content-ops-097-operator-gigrin-farm

## Objective
Improve content item operator-gigrin-farm: Gigrin Farm.
Channel: commercial. Content type: operator. Route/slug: /directory/gigrin-farm.
Commercial tier: unclassified_operator.
Known blocker: Operator "Gigrin Farm Red Kite Feeding" missing: no cover image, no logo, no phone, no email | Operator "Gigrin Farm Red Kite Feeding" missing: no cover image, no logo, no phone, no email.
...
- Content item: operator-gigrin-farm
- Channel: commercial
- Content type: operator
- Route/slug: /directory/gigrin-farm
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-gigrin-farm.json
