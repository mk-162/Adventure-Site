# content-ops-083-operator-celtic-canoes

## Objective
Improve content item operator-celtic-canoes: Celtic Canoes.
Channel: commercial. Content type: operator. Route/slug: /directory/celtic-canoes.
Commercial tier: unclassified_operator.
Known blocker: Operator "Celtic Canoes" missing: no description, no cover image, no logo, no email, no Google rating | Operator "Celtic Canoes" missing: no description, no cover image, no logo, no email, no Google rating.
...
- Content item: operator-celtic-canoes
- Channel: commercial
- Content type: operator
- Route/slug: /directory/celtic-canoes
- Current status: qa_needed
- Priority: 34
- Task type: commercial_review
- Recommended skill: directory-premium-lure-model
- Required output path: data/research/content-ops/operator-celtic-canoes.json
